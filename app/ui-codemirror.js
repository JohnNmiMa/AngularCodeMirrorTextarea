...
.directive('uiCodemirror', ['uiCodemirrorConfig',
            ...
            return function postLink(scope, iElement, iAttrs, ngModel) {
                var options = uiCodemirrorConfig.codemirror || {},
                    opts = angular.extend({value: initialTextValue}, options,
                           scope.$eval(iAttrs.uiCodemirror), scope.$eval(iAttrs.uiCodemirrorOpts)),
                    codeMirror,
                ...
                if (iAttrs.uiCodemirror || iAttrs.uiCodemirrorOpts) {
                    ...
                    scope.$watch(iAttrs.uiCodemirrorOpts, function updateOptions(newValues, oldValue) {
